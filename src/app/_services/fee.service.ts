...
export class FeeService {
  ...
  getFeesConditions(
  ...
  ): Observable<FeeConditions> {
    let endpointUrl = environment.feesConditionsUrl;

    if (documentOriginCode && ipRightCategoryCode) {
      endpointUrl =
        endpointUrl +
        `?documentOriginCode=${documentOriginCode}&ipRightCategoryCode=${ipRightCategoryCode}`;
    ...
    return this.http
      .get<FeeConditions>(endpointUrl)
      .pipe(
        catchError((error) =>
          handleError(
            error,
            'Loading Fees Conditions',
            this.toastService,
            this.ms
          )
        )
  ...
  getDocumentOrigins(): Observable<DocumentOrigins[]> {
    return this.http
      .get<DocumentOrigins[]>(`${environment.documentOriginsUrl}`)
      .pipe(
        catchError((error) =>
          handleError(
            error,
        ...
        requestBag: [
          {
            ...
            feeBag: [
              ...
              },
              {
                ...
                feeTypeCode: 'REI',
                feeDescription:
                  'UD-Renewal Fee Number of Logo/Drawing/Unit ( REN | RNL | RDL | RED )',
                basicFeeUnitAmount: 100.0,
                basicFeeUnitQuantity: 1,
                additionalFeeUnitAmount: 10.0,
                additionalFeeUnitQuantity: 1,
              ...
              },
              {
                ...
                feeTypeCode: 'NCL',
                feeDescription:
                  'TM-Specific Goods and Services (Collective | GEN)',
              ...
              },
              {
                ...
                userDocumentCodeName:
                  'Other post filing request with affected file',
              ...
              },
              {
                ...
                userDocumentCodeName:
                  'Change of name and/or address of stakeholders',
                userDocumentType: 'NAS',
                userDocumentTypeName:
                  'Test Change of name and address of stakeholders',
                documentOriginCode: 'VC',
                documentOriginName: 'St. Vincent & Grenadines',
                taxBag: [
                  {
              ...
              },
              {
                ...
                userDocumentCodeName:
                  'Response to User document or Office document',
