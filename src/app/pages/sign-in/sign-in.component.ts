      ...
      .subscribe({
        next: (response) => {
          if (response.isSignedIn) {
            // Set the current office in the OfficeContextService
            this.officeContext.setCurrentOffice(this.officeCode);
            ...
            this.router.navigate([
              `/${this.officeCode}/${this.langCode}/${defaultLandingModule}`,
            ]);
          }
        },
        error: (error) => {
